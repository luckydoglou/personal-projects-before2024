...
/**
// profiling on PE1, for debugging purpose.
void Profiling() {
  ...
  GPIO_PORTB_DIR_R |= 0x00F;      	// make PB3-0 out
...
int main(void){ 
  TExaS_Init(ADC0_AIN1_PIN_PE2, UART0_Emulate_Nokia5110_NoScope);
	...
	// Profiling();					// initialize profiling on PF1 (optional)
  EnableInterrupts();
	Nokia5110_OutString("Lab 14:");	// print a welcome message
