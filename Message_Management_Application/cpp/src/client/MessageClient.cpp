...
/**
 * Copyright (c) 2019 Tim Lindquist, Xiaolou Huang (Lor) 
 ...
 * @author Xiaolou (Lor) Huang (xhuan127@asu.edu), Software Engineering.
 * @file    Client.cpp
 * @date    March, 2019
 **/
...
class MessageClient : public MessageGui {
    ...
    */
    ...
    /*
    * This method retrieve data from backend(messagelibrarystub) and populate to GUI
    * @param w
    * @param userdata
    */
    static void ClickedGet(Fl_Widget * w, void * userdata) {
        ...
        ////DEBUG
        //for (auto x : msgHeaders) {
        //  cout << "msgHeaders: " << x << endl;
        //}
    ...
    */
    ...
    string urlServer;
    //messagelibrarystub messageLib; // one instance will be instantiated for everything
    MessageClient(const char * name = 0, string urlServer = "http://localhost:8080", string userId = "Xiaolou.Huang") : MessageGui(name) {
        callback(ClickedX);
